...
Best fitness Bootstrap Website Template is a one page website designed for a health and fitness industry. This template developed with valid HTML5 & CSS3. It's based on latest Bootstrap framework 3.3.1 fully responsive web compatible with multi browser and devices. This template is dedicated to create a fitness studio, gym, sports website which can also be used for multi-purpose needs like business, consultancy and portfolio.
